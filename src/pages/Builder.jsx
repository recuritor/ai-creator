...
export default function Builder() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0A0D14] text-white pt-24 px-6 overflow-hidden">
      <NeuralBackground />
      <Navbar />

      {/* HEADER */}
      <div className="relative z-10 max-w-7xl mx-auto mb-10">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight drop-shadow-[0_0_30px_rgba(79,172,254,0.3)]">
          Greywave AI Builder
        </h1>
